...
class Router {
  ...
  static runCommand(message, argsInfo, cmdInfo) {
    argsInfo.Output._onError = cmdInfo.command ? argsInfo.Output.onError : () => {};
    if (cmdInfo.requires) {
